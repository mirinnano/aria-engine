...
public static class UIThemeDefaults
{
    ...
    public const int TextboxCornerRadius = 0;
    public const string TextboxBgColor = "#0b0d10";
    public const int TextboxBgAlpha = 80;
    ...
    public const int ChoiceBgAlpha = 80;
    public const string ChoiceHoverColor = "#252a2f";
    public const int ChoiceCornerRadius = 0;
