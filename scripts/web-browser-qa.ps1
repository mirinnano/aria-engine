param(
    ...
    [string]$OutputPath = "artifacts/release/readiness/web-browser-qa-manifest.json",
    [string]$Browser = "Chrome",
    [string]$ViewportName = "desktop-16x9",
...
$runner = Join-Path $PSScriptRoot "web-browser-qa.mjs"

if (-not (Test-Path -LiteralPath $runner -PathType Leaf)) {
    throw "Web browser QA runner missing: $runner"
}
...
if ($LASTEXITCODE -ne 0) {
    throw "Web browser QA gate failed."
}
